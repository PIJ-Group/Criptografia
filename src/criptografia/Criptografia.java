...
public class Criptografia {
					...
					if (us.getNombre().equals(usuario) && us.getContraseña().equals(hash(contraseña))) {
						...
						do {
							...
							case "2":
								...
								JOptionPane.showMessageDialog(null, "Mensaje cifrado: " + bytesMensajeOriginalCifrado);
								//Mostramos el mensaje descifrado
								JOptionPane.showMessageDialog(null, "Mensaje Descifrado: " + new String (mensajeCifrado));
	...
	public static String hash(String contraseña) throws NoSuchAlgorithmException {
		...
		return passwordUserHash;
			...
			System.out.println("El usuario a pulsado cancelar");
			return null;
		}
